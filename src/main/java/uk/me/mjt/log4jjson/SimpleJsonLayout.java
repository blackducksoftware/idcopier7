...
public class SimpleJsonLayout extends Layout {
	...
	/**
	 * Method called near the end of formatting a LoggingEvent in case users want to override the default object fields.
	 * 
	 * @param le
	 *            the event being logged
	 * @param r
	 *            the map which will be output.
	 */
	...
	/**
	 * LoggingEvent messages can have any type, and we call toString on them. As the user can define the toString method, we should catch any exceptions.
	 * 
	 * @param obj
	 * @return
	 */
	...
	/**
	 * Safe integer parser, for when line numbers aren't available. See for example https://github.com/michaeltandy/log4j-json/issues/1
	 * 
	 * @param obj
	 * @return
	 */
	...
	/**
	 * If a throwable is present, format it with newlines between stack trace elements. Otherwise return null.
	 */
	...
	/*
	 * public String getMinimumLevelForSlowLogging() { return minimumLevelForSlowLogging.toString(); }
	 */
