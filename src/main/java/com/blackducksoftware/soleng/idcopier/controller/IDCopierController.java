...
public class IDCopierController {
	...
	public ModelAndView processLogin(@RequestParam(value = "project-id", required = false) String projectId, Model model) {
		ModelAndView modelAndView = new ModelAndView();
	...
	public String hi(@RequestParam(value = "name", required = false) String name, Model model) {
		String message = name + "!";
